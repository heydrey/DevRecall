...
<template>
  <div class="profile-page page-stack">
    ...
    <p class="telegram-note offline-note" v-if="syncStore.status === 'offline'">Офлайн-режим: карточки доступны, ответы сохраняются на устройстве и уйдут в облако автоматически после возврата сети.</p>
...
.offline-note { margin-top:0; background:#fff8e7; color:#77510d; }
